...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Practica asincronia en flutter Roger',
      debugShowCheckedModeBanner: false,
      theme: ThemeData(
        primarySwatch: Colors.grey,
      ),
      home: const MyHomePage(title: 'Practica asincronia en flutter Roger'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _animateContainer() {
    ...
    setState(() {
      _containerWidth = random.nextInt(1000).toDouble();
  ...
  void _animateContainer1() {
    ...
    setState(() {
      _containerWidth1 = random1.nextInt(1000).toDouble();
  ...
  void _animateContainer2() {
    ...
    setState(() {
      _containerWidth2 = random2.nextInt(1000).toDouble();
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              child: const Icon(Icons.agriculture_rounded, size: 50),
            ),
            AnimatedContainer(
              duration: Duration(seconds: 1),
              curve: Curves.easeInOut,
